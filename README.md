# Assignment 8: Create a Mobile-Responsive Website
...
[Since 2017, over half of all website traffic originates from mobile devices](https://www.oberlo.com/statistics/mobile-internet-traffic). In this assignment, you will use CSS media queries to make your website responsive to different screen sizes. This assignment is designed to help you practice creating layouts that adapt to mobile devices.
